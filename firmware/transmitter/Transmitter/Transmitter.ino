...
// ESP-NOW receiver address (specific repeater MAC address)
uint8_t receiverAddress[] = {0x48, 0x55, 0x19, 0xF0, 0xC5, 0x5A};
...
void transmitStepData() {
  ...
  uint8_t result = esp_now_send(receiverAddress, (uint8_t *) &stepData, sizeof(stepData));
  ...
  if (result == 0) {
    ...
    Serial.print("📡 Receiver MAC: 48:55:19:F0:C5:5A");
    Serial.println();
  } else {
